class ConversationsController < ApplicationController
	...
	def index
		if @box.eql? "inbox"
			@conversations = @mailbox.inbox.paginate(page: params[:page], per_page: 15)
		elsif @box.eql? "sentbox"
			@conversations = @mailbox.sentbox.paginate(page: params[:page], per_page: 15)
		else
			@conversations = @mailbox.trash.paginate(page: params[:page], per_page: 15)
		end
